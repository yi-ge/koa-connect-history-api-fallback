...
function getLogger (opts) {
  return (
    ...
    opts && opts.verbose ? console.log.bind(console) :
    () => {}
  )
}

function makeKoaConnectHistoryApiFallbackMiddleware (options) {
  options = options || {}
...
module.exports = makeKoaConnectHistoryApiFallbackMiddleware
